...
import com.devchw.gukmo.config.NaverLoginConfig;
...
public class NaverLoginService {
    ...
    public void setProfileApiUrl(String value) {
        PROFILE_API_URL = value;
    }
    ...
    public String getAuthorizationUrl(HttpSession session) {
        ...
        OAuth20Service oauthService = new ServiceBuilder()
                ...
                .build(NaverLoginConfig.instance());
    ...
    public String getUserProfile(OAuth2AccessToken oauthToken) {
        try {
            OAuth20Service oauthService = new ServiceBuilder()
                    .apiKey(CLIENT_ID)
                    .apiSecret(CLIENT_SECRET)
                    .callback(REDIRECT_URI).build(NaverLoginConfig.instance());
