  ...
  <div class="container my-5">
    ...
    <form name="writerFrm" class="d-flex flex-column" enctype="multipart/form-data">
      ...
      <div class="d-flex align-items-center my-2">
        ...
        <c:if test="${loginMember.userRole == 'ACADEMY'}">
      ...
      <div class="d-flex align-items-center my-2">
        ...
        <input type="text" id="representativeName" name="representativeName" class="academy_input border rounded pl-2 w-100" value="${board.academy.representative_name}" placeholder="대표자명을 입력해주세요" maxlength="10">
      </div>
